...
import { Sparkles, Loader2, Eye, EyeOff, ArrowLeft, CheckCircle2, Star, Phone } from "lucide-react";
        ...
        <div className="flex-1 flex items-center justify-center px-6 py-24">
          <div className="w-full max-w-[380px] space-y-8">
            ...
            {!showPhone ? (
              ...
              <PhoneAuthPanel onBack={() => setShowPhone(false)} nameForSignup={name || undefined} />
            )}
